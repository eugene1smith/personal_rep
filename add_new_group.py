...
class add_new_group(unittest.TestCase):
    ...
    def test_add_new_group(self):
        ...
        wd.find_element_by_name("group_name").send_keys("My new group")
        ...
        wd.find_element_by_name("group_header").send_keys("My new header")
        wd.find_element_by_name("group_footer").click()
        wd.find_element_by_name("group_footer").clear()
        wd.find_element_by_name("group_footer").send_keys("My new footer")
